...
<div class="container">
    <div class="row">
        <div class="col-sm-4 col-sm-offset-4 custom-login">
            <form action="<?=base_url('newRegister')?>" method="post">
                <?=csrf_field()?>
                ...
                <div class="form-group">
                  ...
                  <div class="text-danger"><?=isset($validation) ? display_error($validation, 'confirm_password') : ''?></div>
                </div>
                
                <button type="submit" class="btn btn-default">Register</button>
                <br>
                <br>
                <a href="<?=base_url('login')?>">I already have an account, login now</a>
              </form>
        </div>
    </div>
</div>

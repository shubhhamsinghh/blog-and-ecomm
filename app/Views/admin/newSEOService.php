...
<?= $this->section('title')?> New SEo Service <?= $this->endSection() ?>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action='<?=base_url("adminNewPostSEOService")?>' method="post" enctype="multipart/form-data">
                <?=csrf_field()?>
            <div class="card-body">
                <div class="row mt-4">
                    <div class="col-md-8">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="title" id="" placeholder="SEO Service Title" >
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        <div class="form-group">
                           ...
                           <textarea class="form-control" name="description" cols="30" rows="10" id="" placeholder="SEO Service Description" ></textarea>
                ...
                <button type="submit" class="btn btn-success"> Add SEO Service</button>
            </div>
            </form>
        </div>
    </div>

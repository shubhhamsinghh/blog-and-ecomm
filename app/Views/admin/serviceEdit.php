...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            ...
            <form action="<?=base_url("adminEditPostService/".$service['id'])?>" method="post" enctype="multipart/form-data">
                <?=csrf_field()?>
            <div class="card-body">
                <div class="row mt-4">
                    <div class="col-md-8">
                        <div class="form-group">
                           ...
                           <input type="text" class="form-control" name="title" id="" placeholder="Service Title" value="<?=$service['title']?>">
                 ...
                 <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            ...
                            <img src="<?=base_url("services/".$service['thumbnail'])?>" height="200px">
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        <div class="form-group">
                           ...
                           <textarea class="form-control" name="description" cols="30" rows="10" id="" placeholder="Service Description" ><?=$service['description']?></textarea>

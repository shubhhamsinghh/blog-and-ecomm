...
$tinybrowser['path']['image'] = '/files/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/files/'; // Media files location
